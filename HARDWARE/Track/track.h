...
#define SEARCH_OUT_PIN_1 GPIO_Pin_5
#define SEARCH_OUT_GPIO_1 GPIOB
#define SEARCH_OUT_IO_1 GPIO_ReadInputDataBit(GPIOB, SEARCH_OUT_PIN_1)

#define SEARCH_OUT_PIN_2 GPIO_Pin_7
#define SEARCH_OUT_GPIO_2 GPIOD
#define SEARCH_OUT_IO_2 GPIO_ReadInputDataBit(GPIOD, SEARCH_OUT_PIN_2)

#define SEARCH_OUT_PIN_3 GPIO_Pin_5
#define SEARCH_OUT_GPIO_3 GPIOD
#define SEARCH_OUT_IO_3 GPIO_ReadInputDataBit(GPIOD, SEARCH_OUT_PIN_3)

#define SEARCH_OUT_PIN_4 GPIO_Pin_3
#define SEARCH_OUT_GPIO_4 GPIOD
#define SEARCH_OUT_IO_4 GPIO_ReadInputDataBit(GPIOD, SEARCH_OUT_PIN_4)

#define SEARCH_OUT_PIN_5 GPIO_Pin_1
#define SEARCH_OUT_GPIO_5 GPIOD
#define SEARCH_OUT_IO_5 GPIO_ReadInputDataBit(GPIOD, SEARCH_OUT_PIN_5)

#define SEARCH_OUT_PIN_6 GPIO_Pin_12
#define SEARCH_OUT_GPIO_6 GPIOC
#define SEARCH_OUT_IO_6 GPIO_ReadInputDataBit(GPIOC, SEARCH_OUT_PIN_6)

#define SEARCH_OUT_PIN_7 GPIO_Pin_10
#define SEARCH_OUT_GPIO_7 GPIOC
#define SEARCH_OUT_IO_7 GPIO_ReadInputDataBit(GPIOC, SEARCH_OUT_PIN_7)
